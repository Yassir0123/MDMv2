          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
            ...
            <div className="lg:col-span-4 space-y-4">
              ...
              <div className={styles.card}>
                ...
                <div className="p-4">
                  {selectedAgence.chefAgenceNom && !selectedAgence.chefAgenceNom.startsWith("Non Assign") ? (
                    ...
                    <td className={styles.td}>
                      <div className="flex items-center gap-2">
                        <div className="w-5 h-5 rounded-full bg-blue-100 text-blue-600 flex items-center justify-center text-[10px] font-bold">
                          {agence.chefAgenceNom && !agence.chefAgenceNom.startsWith("Non Assign") ? agence.chefAgenceNom.charAt(0) : "?"}
                        </div>
                        <span className="text-xs font-medium text-slate-600">
                          {agence.chefAgenceNom && !agence.chefAgenceNom.startsWith("Non Assign") ? agence.chefAgenceNom : "Non assigné"}
                        </span>
                      </div>
                    </td>
